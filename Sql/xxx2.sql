...
--
-- Host: 127.0.0.1
-- Generation Time: May 01, 2015 at 08:38 PM
...
(110, 85, 1, 3, '<p><img class="fr-fin fr-dib" alt="Image title" src="http://i.froala.com/download/301030946c68a67e13818b38791d789fa8a62f2e.jpg?1430470249" width="143"></p><p>Đây là ai?</p>', 1, '311'),
(110, 86, 2, 1, '<p>Đâu là kim loại</p>', 1, '314-315-'),
(110, 87, 3, 3, '<p><strike>Sắt</strike> là <strike>kim loại</strike> có hai hóa trị.</p>', 3, '');
...
(105, 1, 1, 1, 1, 1, 'Đề mẫu số 1', 30, 0, 'dsa', '2015-04-30', NULL, ' dsa											', 2, 'tranthanhdien', NULL),
(106, 1, 1, 1, 1, 1, 'DDee', 1, 1, 'dsa', '2015-04-30', NULL, 'dsa											', 3, 'tranthanhdien', NULL),
(107, 1, 1, 6, 1, 1, 'DDeef maamdsa', 120, 1, 'dsadsa', '2015-04-30', NULL, 'dsa											', 3, 'tranthanhdien', NULL),
(108, 1, 1, 1, 1, 1, 'xxx', 1, 1, 'dsa', '2015-04-29', NULL, 'dsa											', 3, 'tranthanhdien', NULL),
(109, 1, 1, 1, 1, 1, 'acb', 30, 0, 'dsa', '2015-04-30', NULL, ' dsa											', 30, 'tranthanhdien', NULL),
(110, 1, 1, 5, 1, 1, 'Đề kiểm tra hệ số 2', 10, 1, '123456', '2015-05-29', NULL, 'Không được xem tài liệu											', 1, 'tranthanhdien', NULL);
...
CREATE TABLE IF NOT EXISTS `dethi_lop` (
  ...
  KEY `fk_dethi_lop_phongthi` (`MSPT`)
...
('12A1', 109, 1, '2015-04-30', '09:30:00', '10:30:00');
...
(337, 110, 'tranthanhdien', 5, 5, NULL, NULL, NULL, NULL),
(338, 110, 'nguyenminhtri', 4, 5, 7, '2015-05-01', '07:30:00', '08:30:00'),
(339, 110, 'nguyenvannhan', 4, 5, 7, '2015-05-01', '07:30:00', '08:30:00'),
(340, 110, 'thaiquocdung', 4, 5, 7, '2015-05-01', '07:30:00', '08:30:00'),
(341, 110, 'huynhnhatminh', 3, 5, 6, '2015-05-01', '07:30:00', '08:30:00'),
(342, 110, 'truongvanmenh', 4, 5, 6, '2015-05-01', '07:30:00', '08:30:00'),
(343, 110, 'nguyenvikhang', 4, 5, 6, '2015-05-01', '07:30:00', '08:30:00'),
(344, 109, 'nguyenvanbao', 4, 1, 7, '2015-05-01', '01:30:00', '02:30:00');
...
ALTER TABLE `dethi_lop`
  ADD CONSTRAINT `fk_dethi_lop_phongthi` FOREIGN KEY (`MSPT`) REFERENCES `phongthi` (`MSPT`) ON DELETE CASCADE ON UPDATE CASCADE,
