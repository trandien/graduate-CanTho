...
public class PhancongvaitroId implements java.io.Serializable {
	...
	public PhancongvaitroId(String msdt, String ndTaikhoan, String msvt) {
		this.msdt = msdt;
	...
	@Column(name = "MSVT", nullable = false, length = 200)
	public String getMsvt() {
		return this.msvt;
	}

	public void setMsvt(String msvt) {
		this.msvt = msvt;
	}
	...
	public boolean equals(Object other) {
		...
		return ((this.getMsdt() == castOther.getMsdt()) || (this.getMsdt() != null
				...
				&& ((this.getMsvt() == castOther.getMsvt()) || (this.getMsvt() != null
						&& castOther.getMsvt() != null && this.getMsvt()
						.equals(castOther.getMsvt())));
	}
		...
		result = 37
				* result
				+ (getNdTaikhoan() == null ? 0 : this.getNdTaikhoan()
						.hashCode());
		result = 37 * result
				+ (getMsvt() == null ? 0 : this.getMsvt().hashCode());
		return result;
	}
