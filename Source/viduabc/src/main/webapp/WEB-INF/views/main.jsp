...
<body style="font-family: 'Source Sans Pro', sans-serif;">
	...
	<div id="form-card-delete" style="display: none">
		...
		<hr />
		<div class="form-body">
			Bạn có chắc chắn muốn xóa đề thi này ? <br /> <b>Chú ý:</b> Đề thi đã xóa
			không thể khôi phục
		</div>
	...
	<form id="edit">
	        <div class="form-group">
	            ...
	            <textarea type="text" class="field form-control" style="height: 66px;"></textarea>
	        </div>
	        <div class="form-group">
	            ...
	            <div class="panel-body">
	                <form class="form form-vertical">  
	                    ...
	                    <div class="form-group">
	                        ...
	                        <div class="controls">
	                            <input type="text" class="form-control" placeholder="Tên người ra đề">
	                        </div>
	                    </div>    
	                        
	                    <div class="form-group">
	                        <div class="controls">
	                        	<button type="submit" class="btn btn-primary" style="margin-left: 40%;">Tìm kiếm</button>
	                        </div>
	                    </div>       
	            	</form>	               
	            </div><!--/panel content-->
...
-->
		...
		<div class="col-xs-12 col-sm-9 col-md-9 col-lg-9" id="kq_tim_dethi">
			<div class="container">
				<h3 align="center" style="font-family: arial; color: #3b5998;">Danh sách đề thi</h3>
				<hr>
				<div id="wrapper">
        <!-- Page Content -->
                    ...
                    <div class="list-wrapper" id="content-1">
                        <div class="list">
                            <div class="list-header editable">
                                ...
                                <div class="dropdown">
                                    <div class="dropdown-toggle option" id="ddMenu1" data-toggle="dropdown">
                                    ...
                                    <ul class="dropdown-menu" role="menu" aria-labelledby="ddMenu1">
                                        ...
                                        <li role="presentation" style="text-align:center;">
                                            <button class="btn btn-danger btn-block">Xóa nhóm</button>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            <ul class="list-content">
                                <li class="list-item" data-toggle="modal" data-target="#myModal">
                            ...
                            <form role="form">
                                <div class="form-group create">
                                    <input type="text" class="form-control" placeholder="Thêm thẻ mới...">
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="list">
                            <div class="list-header editable">
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" role="menu" aria-labelledby="ddMenu1">
                                        <li role="presentation" class="dropdown-header">Xóa nhóm</li>
                                        <li role="presentation" class="divider"></li>
                        ...
                        <form role="form">
                            <div class="form-group create-list">
                                <input type="text" class="form-control" placeholder="Điền tên và bấm enter để thêm danh sách">
                            </div>
                        </form>
                    </div>
                </div>
