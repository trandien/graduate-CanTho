...
<link rel="stylesheet" type="text/css"
	href="<c:url value="/resources/custom/DSThiSinhThi.css" />" />
...
<body style="font-family: 'Calibri', sans-serif; font-size: 18px;">
	...
	<input type='hidden' id='soLanThi' value='${msdt }'>
	<h3 align="center" style="color: #3b5998;">
		<strong>Danh sách thí sinh tham gia thi</strong>
	</h3>
	<div class="container">
		<table class="table table-bordered table-hover"
			...
			<tbody>
				<c:forEach items="${hocSinhThi }" var="thisinh" varStatus="status">
					<tr>
						<td><c:out value="${status.count}" /></td>
						<td>${thisinh.ndHoten }</td>
						<td width="100px;">
							<div id='comat-${thisinh.ndTaikhoan }'></div>
						</td>
						<td>${thisinh.lop.msl }</td>
						<td><div id='diem-${thisinh.ndTaikhoan }'></div></td>
						<td width="200px;">
							<div class="onoffswitch">
								<input type="checkbox" name="${thisinh.ndTaikhoan }"
									class="onoffswitch-checkbox" id="check-${thisinh.ndTaikhoan }"
									checked disabled> <label class="onoffswitch-label"
									for="check-${thisinh.ndTaikhoan }"> <span
